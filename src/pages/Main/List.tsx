...
import { COLORS, SIZES, icons,  data } from '../../exports';

// import { TextReadMore } from "../../components";

import Animated from 'react-native-reanimated';

const List = ({ route, navigation, style }) => {
        ...
        return (
            <View style={{ padding: SIZES.padding }}>
                <View style={{ width:'100%'}}>
                    ...
                    A Cappuccino is a coffee-based drink made primarily from Espresso and It is one of the most popular drinks in the world
                    </Text>
